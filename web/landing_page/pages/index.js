      ...
      <section id="join" className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden">
        ...
        <div className="text-center max-w-2xl w-full reveal-text relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center w-full max-w-2xl mx-auto">
            ...
            <button 
              onClick={handleCTAClick}
              className="group w-full sm:w-auto px-10 py-5 bg-white text-black border-2 border-black rounded-full font-medium text-lg hover:bg-gray-100 transition-colors duration-300 shadow-xl flex items-center justify-center gap-2"
            >
              Join Waitlist
            </button>
          </div>

          <div className="mt-16 flex flex-wrap items-center justify-center gap-10 opacity-70 hover:opacity-100 transition-all duration-500">
            {/* Aptos */}
            <div className="flex items-center gap-2">
              <img src="/assets/Aptos-Network-Full-Logo-Black-RGB-1x.png" alt="Aptos" className="h-6" />
            </div>

            {/* Anthropic Logo */}
            <div className="flex items-center gap-2">
              <img src="/assets/anthropic.png" alt="Anthropic" className="h-5" />
            </div>

            {/* ChatGPT Logo */}
            <div className="flex items-center gap-2">
              <img src="/assets/ChatGPT-Logo.png" alt="ChatGPT" className="h-6" />
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-4 w-full flex flex-col items-center gap-3 z-10">
          ...
          <div className="flex items-center gap-4">
            <a href="https://x.com/SaabiqSaha" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-black transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
              </svg>
            </a>
            <a href="https://www.linkedin.com/in/mohammed-saabiq-saha-abdulai-099b00257/" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-black transition-colors">
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
